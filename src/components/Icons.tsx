...
export const BirdIcon = ({ size = 20, className = '' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M22 4.5c0-.83-.67-1.5-1.5-1.5a1.5 1.5 0 0 0-1.06.44L17 5.88V4a1 1 0 0 0-2 0v4l-3.17 3.17A6.5 6.5 0 0 0 3.5 17c0 1.93.84 3.67 2.17 4.87L5 23h14l-.67-1.13A6.49 6.49 0 0 0 20.5 17c0-1.37-.43-2.64-1.15-3.69L22 10.88V4.5z"/>
  </svg>
)
